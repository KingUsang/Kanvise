      ...
      <div className="space-y-6">
        <section className="rounded-2xl border border-[#e5e1dd] bg-white p-5 sm:p-6">
          ...
          {nextClass ? <div className="mt-5 rounded-2xl border-l-4 border-[#c26627] bg-[#faf8f5] p-4 sm:flex sm:items-center sm:justify-between sm:gap-5">
            ...
            <Link href={`/class/${nextClass.id}`} className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#994704] px-5 py-3 text-sm font-semibold text-white hover:bg-[#7f3a03] sm:mt-0 sm:w-auto"><Video size={17} />{nextClass.status === "live" ? "Join class" : "View class"}</Link>
