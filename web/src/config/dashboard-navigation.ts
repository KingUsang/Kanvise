...
export type DashboardArea = 'home' | 'classes' | 'teaching' | 'mocks' | 'centre'
...
export const dashboardWorkspaces: DashboardWorkspace[] = [
  ...
  { label: 'Classes', href: '/dashboard/schedule', icon: 'calendar_month', area: 'classes', access: 'shared' },
  { label: 'Teaching', href: '/dashboard/teaching', icon: 'school', area: 'teaching', access: 'tutor' },
  { label: 'Mocks', href: '/dashboard/mocks', icon: 'quiz', area: 'mocks', access: 'shared' },
  { label: 'Centre', href: '/dashboard/centre', icon: 'domain', area: 'centre', access: 'admin' },
]

export const dashboardNavItems: DashboardNavItem[] = [
  { label: 'Dashboard', href: '/dashboard', icon: 'space_dashboard', area: 'home', access: 'all', keywords: ['home', 'overview'] },
  { label: 'Centre', href: '/dashboard/centre', icon: 'domain', area: 'centre', access: 'admin', keywords: ['centre', 'school', 'operations'] },
  ...
  { label: 'Programmes', href: '/dashboard/programmes', icon: 'library_books', area: 'centre', access: 'admin', keywords: ['programmes', 'subjects', 'curriculum'] },
  ...
  { label: 'Classes', href: '/dashboard/schedule', icon: 'calendar_month', area: 'classes', access: 'shared', keywords: ['schedule', 'calendar', 'classes', 'sessions'] },
  { label: 'Attendance insights', href: '/dashboard/attendance', icon: 'fact_check', area: 'classes', access: 'shared', keywords: ['attendance', 'participation', 'sessions'] },
  { label: 'Mocks', href: '/dashboard/mocks', icon: 'quiz', area: 'mocks', access: 'shared', keywords: ['mocks', 'exams', 'tests', 'grading'], badge: 'ungradedMocks' },
  ...
  { label: 'Teaching', href: '/dashboard/teaching', icon: 'school', area: 'teaching', access: 'tutor', keywords: ['teaching', 'materials', 'assignments'] },
